...
+   <uses-permission android:name="android.permission.READ_EXTERNAL_STORAGE"/>+   <!-- If your app targets Android 13 (API level 33) or higher, you must declare the NEARBY_WIFI_DEVICES permission. -->
